...
description: "Aspose.Tasks Cloud allows you to get project calendar items in MPP, MPT and XML. Moreover, our REST API can be used with nearly all languages like .NET, Node.JS, Python, PHP, Go, Java and many more."
type: docs
...
{{< gist "aspose-cloud" "778c73d65cee00b98af00c9a48e36147" "Examples-GetCalendars.java" >}}
